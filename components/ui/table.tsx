...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "no-hover [&_tr]:border-b [&_tr:hover:bg-transparent] [&_tr]:cursor-default",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b-2 border-gray-200 transition-colors hover:bg-white/70 data-[state=selected]:bg-neutral-100 dark:hover:bg-neutral-800/50 dark:data-[state=selected]:bg-neutral-800",
      "cursor-pointer",
      className,
