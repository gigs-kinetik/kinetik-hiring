            ...
            <form onSubmit={handleSubmit}>
                <div className="flex flex-col bg-white rounded-lg p-5">
                    ...
                    <p className="font-poppins mt-1 sm:text-sm text-xs text-gray-500">
                        Please attach your GitHub link (coding submission) or
                        Google Drive link (business proposal) with proper
                        access.
                    </p>
                    <input
                    ...
                    <p className="font-poppins mt-1 sm:text-sm text-xs text-gray-500">
                        Please attach your resume with proper access. We collect
                        resumes for potential sponsor hiring.
                    </p>
                    <input
                        className="flex font-poppins max-w-96 text-sm text-gray-900 border border-gray-300 rounded-md cursor-text bg-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:ring-logo-purple/90"
                        type="text"
                    ...
                    <p className="font-poppins mt-1 sm:text-sm text-xs text-gray-500">
                        Please attach a quick video of you explaining your
                        product or proposal with proper access.
                    </p>
                    <input
                        className="flex font-poppins max-w-96 text-sm text-gray-900 border border-gray-300 rounded-md cursor-text bg-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:ring-logo-purple/90"
                        type="text"
                    ...
                    <p className="font-poppins mt-1 sm:text-sm text-xs text-gray-500">
                        Please attach any additional links for further review
                        (i.e. website link, server/database link, research
                        articles, etc).
                    </p>
                    <input
                        className="flex font-poppins max-w-96 text-sm text-gray-900 border border-gray-300 rounded-md cursor-text bg-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:ring-logo-purple/90"
