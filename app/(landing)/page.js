        ...
        <div className="font-poppins h-full flex flex-col">
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center w-full space-y-6 lg:space-y-0 lg:space-x-8 px-4">
              ...
              <div className="relative flex flex-col justify-between w-full max-w-xs bg-off-white rounded-xl shadow-md p-4 sm:p-6 min-h-64 sm:min-h-72">
                ...
                <div className="flex-grow flex flex-col items-center justify-center">
                  ...
                  <div className="text-sm sm:text-md mt-3 sm:mt-4 text-gray-500 text-center px-2 sm:px-4">
                    That's it! Now, just wait for Kinetik's comprehensive report
                    on the submissions!
                  </div>
                  <div className="mt-6 sm:mt-8">
          ...
          <div className="flex flex-col w-full pb-16 pt-14 bg-off-white">
            ...
            <div className="flex flex-col xl:flex-row pb-8 text-off-white">
              <div className="flex flex-row flex-wrap justify-around w-full">
                <div className="flex flex-col items-center m-4">
                  <div className="text-center font-medium text-logo-purple mb-3 text-lg">
                    Technical Projects
                  </div>
                  <div className="flex flex-col w-72 p-6 rounded-xl bg-white h-52">
          ...
          <div className="flex flex-col w-full pb-16 pt-14 bg-white">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-6 p-8 text-off-white">
              <div className="flex flex-col items-center p-6 w-80 bg-gray-800 rounded-lg">
                <div className="text-3xl font-bold mb-2">Basic</div>
                <div className="text-4xl font-bold mb-2">Free</div>
                <div className="text-sm text-gray-400 mb-4">Billed Yearly</div>
                <ul className="space-y-3 mb-6 ">
                  <li>- 1 Challenge</li>
                  <li>- Access to Intermediate Developer Pool</li>
                </ul>
                <button className="w-full py-2 bg-white font-semibold rounded-lg text-logo-purple">
                  Get Started
                </button>
              </div>
              <div className="flex flex-col items-center p-6 w-80 bg-logo-purple text-white rounded-lg shadow-lg transform scale-110">
                <div className="text-3xl font-bold mb-2">Unlimited</div>
                <div className="text-4xl font-bold mb-2">
                  $29.99 <span className="text-xl">/ month</span>
                </div>
                <div className="text-sm text-gray-200 mb-4">Billed Yearly</div>
                <ul className="space-y-3 mb-6">
                  <li>- Unlimited Challenges</li>
                  <li>- Access to Experienced Developer Pool</li>
                  <li>- Challenge Fee Payment Flexibility</li>
                  <li>- Full Reporting on Submissions</li>
                </ul>
                <button className="w-full py-2 bg-white font-semibold rounded-lg text-logo-purple">
                  Get Started
                </button>
              ...
              <div className="flex flex-col items-center p-6 w-80 bg-gray-800 rounded-lg">
                ...
                <ul className="space-y-3 mb-6">
                  <li>- 2 Challenges</li>
                  <li>- Access to Advanced Developer Pool</li>
                  <li>- Full Reporting on Submissions</li>
                </ul>
