  ...
  const handleSignUp = async (e) => {
    ...
    if (password.length < 6) {
      ...
      if (!user) {
        ...
        User.verify(user.id, user.email);
      ...
      if (!company) {
        ...
        Company.verify(company.id, company.email);
        alert(
          "Account created successfully, verification email sent, please check your email."
        );
        router.push("/login");
        setLoading(false);
      }
          ...
          <form className="space-y-3" onSubmit={handleSignUp}>
            ...
            {userType === "Company" && (
              <div className="flex items-center justify-center">
                ...
                >
                  I confirm that I am an authorized employee from the company
                  stated above.
                </label>
              </div>
            )}
